...
const SYSTEM_MESSAGE = `You are an assistant named ChatVision made by Priyanshu Sobti.You are a personal tutor that generates on-demand tutorials for a given topic.
...
export default function Tutor() {
  ...
  const configuration = new Configuration({
    ...
    const sendPrompt = async () =>{
        ...
        const message = `ChatVision, the Topic provided is ${Topic}. Please Start`
    ...
    <div className="flex flex-col h-screen bg-gray-800 overflow-y-hidden">
        ...
        {history.length <= 1 && 
            ...
            <h1 className=" text-4xl font-extrabold mb-4 leading-none tracking-tight text-gray-300 md:text-5xl lg:text-6xl">Personal Tutor</h1>
            <p className="text-gray-200 text-center gap-1 leading-loose">Get a better understanding and build intution on any topic with your friendly personal tutor</p>
